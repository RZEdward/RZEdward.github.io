...
Following some intensive efforts in preprocessing, hidden layer selections, and hyperparameter optimization, detailed in this report<!-- add link here -->, the model returned a training accuracy of 95% after 20 epochs, having resized images to 256x256. However, the testing accuracy was considerably lower, and so I will soon introduce anti-ovefitting techniques into the algorithm in order to enhance generalisation to unseen data.
